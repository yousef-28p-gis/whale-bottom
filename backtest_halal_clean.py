...
"""باك تيست 5 سنوات — حلال بدون الأسوأ — حوت القاع"""
...
# استبعاد أسوأ 15 عملة من الباك تيست السابق
BLACKLIST = {
...
print(f'🔍 عملات حلال — مستبعد أسوأ 15 | 5 سنوات | صفقتين×50%')
...
for fname in coin_files:
    ...
    if sym_trades > 0 or done % 10 == 0:
        ...
        print(f'  {done:>3}/109 {sym:<12} {sym_trades:>4}ت | WR {sym_wr:.0f}%', flush=True)
...
print(f'\n{"="*60}')
print(f'📊 حلال بدون أسوأ 15 — 5 سنوات')
print(f'{"="*60}')
