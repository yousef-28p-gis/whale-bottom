#!/usr/bin/env python3
"""Cloud Hunter — 3Y test: ALL halal coins, RSI>50 vs No filter"""
...
print(f"☁️ صياد السحابة | 3 سنوات | كل العملات الحلال | صفقتين × $500\n")

for flt, label in [(None, 'بدون فلتر'), ('rsi50', 'RSI > 50')]:
    print(f"📋 {label}")
