...
"""باك تيست 5 سنوات — خروج كل ساعة (إغلاق شمعة 1h)"""
...
EXIT_STEP = 4  # 4 × 15m = 1h candle close
...
print(f'⏱️  خروج على إغلاق 1h (كل {EXIT_STEP} شمعة 15m)')
...
print(f'\n{"="*60}')
print(f'📊 حلال بدون أسوأ 15 — 5 سنوات — خروج 1h')
print(f'{"="*60}')
